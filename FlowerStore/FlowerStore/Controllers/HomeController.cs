...
namespace FlowerStore.Controllers
{
    ...
    { private AppDbContext _context;
        ...
        public IActionResult Index()
        {
            ...
            return View(new HomeViewModel {slider=slider,valentine=valentine,listItem=listItems,product=products, category=categories,subscribeTable=subscribeTables,experts=experts,title=title,worker=worker,blog=blog,BlogItems=blogItems,Images=images,Hashtag=hashtag });
        }
